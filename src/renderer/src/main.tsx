...
> {
  ...
  render() {
    if (this.state.error) {
      ...
      return (
        <div style={{ padding: 32, color: '#fafafa', fontFamily: 'system-ui', background: '#1c1c1e', minHeight: '100vh' }}>
          <h1 style={{ fontSize: 20, marginBottom: 8 }}>{i18n.t('somethingWentWrong')}</h1>
