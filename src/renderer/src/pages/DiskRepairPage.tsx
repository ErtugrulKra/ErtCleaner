...
export function DiskRepairPage() {
  ...
  useEffect(() => {
    if (!window.ertcleaner?.onDiskRepairProgress) return
    return window.ertcleaner.onDiskRepairProgress((data) => store.setRepairProgress(data))
  }, [])
  ...
  const handleRunSfc = async () => {
    ...
    try {
      const result = await window.ertcleaner.diskRepairSfc('C')
  ...
  const handleRunDism = async () => {
    ...
    try {
      const result = await window.ertcleaner.diskRepairDism()
  ...
  const handleRunChkdsk = async () => {
    ...
    try {
      const result = await window.ertcleaner.diskRepairChkdsk('C')
