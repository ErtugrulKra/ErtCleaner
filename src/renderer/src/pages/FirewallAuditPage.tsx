...
export function FirewallAuditPage() {
  ...
  useEffect(() => {
    const cleanup = window.ertcleaner?.onFirewallProgress?.((data: FirewallScanProgress) => {
  ...
  const handleScan = useCallback(async () => {
    ...
    try {
      const result = await window.ertcleaner.firewallScan()
  ...
  const handleApply = useCallback(async (action: FirewallAction) => {
    ...
    try {
      const result = await window.ertcleaner.firewallApply(
