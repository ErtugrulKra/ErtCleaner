...
export function DuplicateFinderPage() {
  ...
  useEffect(() => {
    if (!window.ertcleaner?.onDuplicatesProgress) return
    return window.ertcleaner.onDuplicatesProgress((data) => {
  ...
  const handleSelectDir = async () => {
    const dir = await window.ertcleaner?.duplicatesSelectDir?.()
  ...
  const handleScan = async () => {
    ...
    try {
      const result = await window.ertcleaner?.duplicatesScan?.({
  ...
  const handleCancel = async () => {
    await window.ertcleaner?.duplicatesCancel?.()
  }
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const result = await window.ertcleaner?.duplicatesDelete?.(paths, store.deleteMode)
      if (result) {
                            ...
                            return (
                              ...
                              >
                                ...
                                <button
                                  onClick={(e) => {
                                    e.stopPropagation()
                                    window.ertcleaner?.duplicatesOpenLocation?.(file.path)
                                  }}
