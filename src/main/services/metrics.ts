...
export async function collectMetrics(): Promise<MetricLine[]> {
  ...
  // App info
  metrics.push({
    name: 'ertcleaner_info',
    type: 'gauge',
    help: 'ErtCleaner application info',
  ...
  // System uptime
  metrics.push({
    name: 'ertcleaner_system_uptime_seconds',
    type: 'gauge',
  ...
  try {
    ...
    metrics.push({
      name: 'ertcleaner_system_cpu_usage_percent',
      type: 'gauge',
    ...
    metrics.push({
      name: 'ertcleaner_system_memory_total_bytes',
      type: 'gauge',
    ...
    metrics.push({
      name: 'ertcleaner_system_memory_used_bytes',
      type: 'gauge',
  ...
  metrics.push({
    name: 'ertcleaner_items_cleaned_total',
    type: 'gauge',
  ...
  metrics.push({
    name: 'ertcleaner_space_saved_bytes_total',
    type: 'gauge',
  ...
  metrics.push({
    name: 'ertcleaner_scan_errors_total',
    type: 'gauge',
  ...
  if (history.length > 0) {
    ...
    metrics.push({
      name: 'ertcleaner_last_scan_timestamp_seconds',
      type: 'gauge',
    ...
    metrics.push({
      name: 'ertcleaner_last_scan_duration_seconds',
      type: 'gauge',
    ...
    metrics.push({
      name: 'ertcleaner_last_scan_items_found',
      type: 'gauge',
