...
function isProtectedFolder(folderPath: string, _platform: string, home: string): boolean {
...
describe('isProtectedFolder', () => {
  ...
  it('protects generic folders (git, node_modules, etc.)', () => {
    ...
    expect(isProtectedFolder('C:\\dev\\project\\node_modules', 'win32', 'C:\\Users\\User')).toBe(true)
    expect(isProtectedFolder('C:\\Users\\User\\.ssh', 'win32', 'C:\\Users\\User')).toBe(true)
    expect(isProtectedFolder('C:\\project\\.env', 'win32', 'C:\\Users\\User')).toBe(true)
    expect(isProtectedFolder('C:\\Users\\User\\.config', 'win32', 'C:\\Users\\User')).toBe(true)
  })
