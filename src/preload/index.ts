...
const api = {
  ...
  // Settings
  settingsGet: (): Promise<ErtCleanerSettings> => ipcRenderer.invoke(IPC.SETTINGS_GET),
  settingsSet: (settings: Partial<ErtCleanerSettings>): Promise<void> =>
...
export type ErtCleanerAPI = typeof api

contextBridge.exposeInMainWorld('ertcleaner', api)
