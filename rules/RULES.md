...
ErtCleaner's cleaning targets are defined as JSON files in this directory. Adding support for a new app, game launcher, or cache location is as simple as editing a JSON file — no TypeScript or Electron knowledge required.

Browse the [full cleaner directory](CATALOG.md) to see what's already covered and what's missing.
